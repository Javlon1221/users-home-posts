...
const DetailPage = () => {
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="ml-48 w-full p-6">
                <Link
                    to="/"
                ...
                <img
                    src={recipe.image}
                    alt={recipe.name}
                    className="w-[600px] h-72 object-cover rounded-xl mb-6 shadow-md ring-2 ring-gray-100"
                />
                <div className="mb-4 ">
                ...
                <p className="mb-6 text-gray-700 leading-relaxed w-[580px]">{recipe.instructions}</p>
